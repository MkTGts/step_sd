...
#admin.create_group(group_name="Админы", invite_token=159753)
#admin.create_user(tg_id=12323, username="qweqwqstepashka", fullname="xzcqstepan", user_type=2 ,group_id=1)
